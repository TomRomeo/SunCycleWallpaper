...
# Initial information
echo ""
echo "This script will configure everything for scw"
echo "and add cron jobs to run things every fifth minute in every"
...
# Final words
echo "Configuration process complete! For more information, please view"
echo "the README.md file here or at github.com/khanu263/SunCycleWallpaper and github.com/TomRomeo/SunCycleWallpaper respectively"
echo ""
